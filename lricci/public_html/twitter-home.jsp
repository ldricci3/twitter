...
<%
	...
	String p_key = session.getVariable("p_key");
                ...
                <div class="module">
                    ...
                    <div class="stream home-stream">
                    	<%
                    		...
                    		String query_combinedTweets = "select * from tweets inner join follow_rel on tweets.user_id=follow_rel.followee_id where follower_id=" + p_key + " order by tweet_id asc;";
