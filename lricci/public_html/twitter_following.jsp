                ...
                <div class="module">
                    ...
                    <div class="stream home-stream">
                    	<%
                    		...
                    		String query_followees = "select * from users inner join follow_rel on users.user_id = follow_rel.followee_id where follower_id ='" + p_key + "';";
                    		
                    		
                    		java.sql.Statement stmt2 = conn.createStatement();
                    		
                    		java.sql.ResultSet rs_followees = stmt2.executeQuery(query_followees);
                    		
                    		int followee_id = 0;
                    		String followee_username = "";
                    		String followee_first_name = "";
                    		String followee_last_name = "";
                    		String followee_fullname = "";
                    		
                    		while(rs_followees.next()) {
                    			followee_id = rs_followees.getInt("user_id");
                    			
                    			if (!Integer.toString(followee_id).equals(p_key)) {
                    				followee_username = rs_followees.getString("username");
                    				followee_first_name = rs_followees.getString("first_name");
                    				followee_last_name = rs_followees.getString("last_name");
                    			
                    				followee_fullname = followee_first_name + " " + followee_last_name;
                    	%>
                                ...
                                <div class="content">
                                    <div class="stream-item-header">
                                        <a class="account-group">
                                            ...
                                            <strong class="fullname"><%=followee_fullname%></strong>
                                            <span>&rlm;</span>
                                            <span class="username">
                                                <s>@</s>
                                                <b><%=followee_username%></b>
                                            </span>
                                        </a>
                                    </div>
                                </div>
